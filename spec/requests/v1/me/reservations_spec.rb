...
RSpec.describe 'v1/me/reservations', type: :request do
  ...
  context 'POST/reservations' do
    it 'should create a new reservation' do
      expect do
        post '/reservations', params: { reservation: { city: 'Imphal', date: '24/08/2022', user_id: @current_user.id, car_id: 1 } }
  ...
  describe 'DELETE #destroy' do
    it 'destroys the requested reservation' do
      reservation = FactoryBot.create(:reservation, city: 'Imphal', date: '24/08/2022', user_id: @current_user.id, car_id: 1)
      expect do
