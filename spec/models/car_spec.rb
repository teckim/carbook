...
RSpec.describe Car, type: :model do
  before :each do
    ...
    @car = Car.create(model: 'Lamborgini', description: 'cool car', price: 250, image: 'https://images.unsplash.com/photo-1519245659620-e859806a8d3b?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80')
  end
